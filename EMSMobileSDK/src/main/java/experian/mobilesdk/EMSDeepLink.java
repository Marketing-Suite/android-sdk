...
public class EMSDeepLink {
  ...
  /**
   * get decoded parameter values from CCMP if any in hashmap format example:
   * http://rts.eccmp.com/rts/go2.aspx?dl=param&page=main&data=url"
   *
   * @return the decoded values in hashmap format example: hashmap data of
   *     (dl,param),(page,main),(data,url)
   */
  ...
  /**
   * get decoded parameter value from CCMP if any; example:
   * http://rts.eccmp.com/rts/go2.aspx?dl=param" url link
   *
